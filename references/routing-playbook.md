...
- `某某用户在 Default 组织下有哪些资产` -> 用户有效访问范围；先解析组织并切到目标组织，再查 `user-assets`
...
- 用户明确说“在 Default 组织下”“在某组织下”这类表达时，视为显式组织；先切到目标组织，再执行 `user-assets` / `user-nodes` / `user-asset-access`。
